                  ...
                  <Grid.Cell columnSpan={{ xs: 1, sm: 2, md: 2, lg: 2, xl: 3 }}>
                    <Box>
                      <BlockStack gap="400">
                        ...
                        <Text tone="subdued">
                          Sync the shipping and payment methods to require a fee
                          for customers who select COD (Cash on Delivery) as
                          their shipping option.
                        </Text>
                        <Box>
                  ...
                  >
                    <Card>
                      <BlockStack gap="300">
                        ...
                        <Box paddingBlockStart="1000">
                          <Text tone="subdued">
                            Example: For COD shipping, show COD payment option
                            with an added fee
                          </Text>
                        </Box>
                      </BlockStack>
                    ...
                    <Card>
                      <BlockStack gap="300">
                        ...
                        <Box paddingBlockStart="1000">
                          <Text tone="subdued">
                            Example: For FedEx shipping, show only Bank
                            Transfer.'
                          </Text>
                        </Box>
                      </BlockStack>
                    ...
                    <Card>
                      <BlockStack gap="200">
                        ...
                        <Box>
                          <InlineStack gap="300">
                            <Text tone="subdued">
                              If you can't find a feature or condition that
                              matches your needs, feel free to request it.
                            </Text>
