            ...
            description: (
              <Card>
                <InlineStack align="space-between">
                  <Box>
                    <InlineStack align="space-between">
                      <Text fontWeight="bold">Activate Checkout rules </Text>
                  ...
                  <Box>
                    {isRules ? (
                      <Button onClick={handleRulesOnClick}>Turn off</Button>
                    ) : (
                      <Button variant="primary" onClick={handleRulesOnClick}>
                        Turn on
                      </Button>
                    )}
                  </Box>
                  ...
                  <RadioButton
                    label={
                      <InlineStack>
                        ...
                        <Text> Allow customer to complete the checkout</Text>
                      </InlineStack>
                    }
            ...
            description: (
              <Card>
                <InlineStack wrap={false} align="center" blockAlign="center">
                  <Box minWidth="200px">
                    <Text>
                      You can share the logs with us for debugging purposes.
                      From the Settings page of Shopify Admin {">"} Apps and
                      sale channels {">"} Blockify: Checkout Rules+ {">"} Click
                      the action button {">"} View details {">"} Scroll down to
                      the Share function logs {">"} Clicks Share logs
                    </Text>
                  </Box>
                  <Box minWidth="86px">
