            ...
            <Grid.Cell>
              ...
              >
                <BlockStack gap="200">
                  ...
                  <Text>Everything you need to start secure checkout </Text>
                  <Box>
                  ...
                  {isPlanFirstButton && (
                    <Text>
                      <InlineStack gap="100">
                        89.99% OFF{" "}
                        <Text textDecorationLine="line-through" tone="critical">
                          $9.99
                        </Text>
                      </InlineStack>
                    </Text>
                  ...
                  <Box>
                    ...
                    <BlockStack gap="200">
                      <InlineStack gap="100">
                        ...
                        <Text tone="subdued">1 active Shipping Discounts</Text>
                      </InlineStack>
                      <InlineStack gap="100">
                        <Box>
                          <Icon source={CheckIcon} tone="subdued" />
                        </Box>
                        <Text tone="subdued">1 active Add fee for COD</Text>
                      </InlineStack>
                      <InlineStack gap="100">
                        <Box>
                          <Icon source={CheckIcon} tone="subdued" />
                ...
                <BlockStack gap="200">
                  ...
                  <Box>
                    <InlineStack gap="100">
                      ...
                      <Text tone="subdued">Unlimited active rules of</Text>
                    </InlineStack>
                    <Box paddingInlineStart="400" paddingBlock="200">
                      <BlockStack gap="050">
                        <Text>
